<div class="topnav-filter">
    <button class="filter-icon" onclick="toggleRotation()">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <title>triangle-down-outline</title>
            <path fill="white" d="M12 22L1 3H23M12 18L19.53 5H4.47" />
        </svg>
    </button>
    <div class="topnav-filter-form">
        <form>
            ...
            <div class="filter-input">
                <button>
                    <svg width="10%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <title>Filter-Data</title>
                        <path fill="hsl(216, 100%, 50%)"
