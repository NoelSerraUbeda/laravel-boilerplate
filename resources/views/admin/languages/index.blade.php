                ...
                @foreach($languages as $language_element)
                    <div class="crud-card">
                        <div class="crud-card-buttons">
                            <button class="edit edit-button" data-endpoint="{{route('languages_edit', ['language' => $language_element->id])}}">
                            ...
                            <button class="delete destroy-button" data-endpoint="{{route('languages_destroy', ['language' => $language_element->id])}}">
                                <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                                    <title>Delete</title>
                        ...
                        <div class="crud-card-data">
                            <h3>Nombre: <span>{{$language_element->name}}</span></h3>
                            <h3>Alias: <span>{{$language_element->label}}</span></h3>
                            <h3>Creado el: <span>{{$language_element->created_at}}</span></h3>
                            <h3>Actualizado el: <span>{{$language_element->updated_at}}</span></h3>
                        </div>
                    </div>
                @endforeach
            @endisset
...
@section('form')
    ...
    <div class="crud-form-buttons">
        ...
        <div class="button-panel">
            <div class="save">
                <button class="store-button" data-endpoint="{{route('languages_store')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div class="erase" >
                <button class="create-button" data-endpoint="{{route('languages_create')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
