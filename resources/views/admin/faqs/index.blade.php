                ...
                @foreach($faqs as $faq_element)
                    <div class="crud-card">
                        <div class="crud-card-buttons">
                            <button class="edit edit-button" data-endpoint="{{route('faqs_edit', ['faq' => $faq_element->id])}}">
                            ...
                            <button class="delete destroy-button" data-endpoint="{{route('faqs_destroy', ['faq' => $faq_element->id])}}">
                                <svg  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> 
                                    <title>Delete</title>
                        ...
                        <div class="crud-card-data">
                            <h3>Nombre: <span>{{$faq_element->name}}</span></h3>
                            <h3>Creado el: <span>{{$faq_element->created_at}}</span></h3>
                            <h3>Actualizado el: <span>{{$faq_element->updated_at}}</span></h3>
                        </div>
                    </div>
                @endforeach
            @endisset
...
@section('form')
    ...
    <div class="crud-form-buttons">
        ...
        <div class="button-panel">
            <div class="save">
                <button class="store-button" data-endpoint="{{route('faqs_store')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div class="erase" >
                <button class="create-button" data-endpoint="{{route('faqs_create')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <form>
            <div class="tab-content active" data-tab="general">
                ...
                <div class="area-section">
                    <label>Name</label>
                    <input class="long" id="name" name="name" type="text" autocomplete="name" value="{{$faq->name ?? ''}}">
                </div>
            </div>
